...
const productsForHome = gql`
  query ($ip: String!, $cartId: String!) {
    productsForHome(ip: $ip, cartId: $cartId) {
      products {
        productName
        pricePkt
        categoryId
...
function Items(props) {
  ...
  useEffect(() => {
    ...
    if (products) {
      localStorage.setItem("cartId", products.cartId);
    ...
    if (!validatePhoneNo(phoneNo.current.value)) {
      ...
      await confirmationResult
        ...
        .then(async (res) => {
          ...
          await props.updateCartVerified({
            variables: {
              id: cartId !== undefined && cartId !== null ? cartId : "",
              phoneNo: phoneNo.current.value,
              productList: cart !== undefined && cart !== null ? cart : "",
              closed: true,
            },
          });
  ...
  const sendotp = async () => {
    ...
    if (name.current.value != "" && phoneNo.current.value != "") {
      if (validatePhoneNo(phoneNo.current.value)) {
        firebase
          .auth()
  ...
  const handleChange = async (event) => {
    ...
    history.replace(
      "/products?categoryId=" + arr[0] + "&categoryName=" + arr[1]
    );
  };
  const handleClose = () => {
    setOpen(false);
    ...
    <div>
      ...
      <div className={classes.isDesktop}>
        <img
          ...
          className={classes.standardImg}
        ></img>
        <div className={classes.typoDiv}>
          <p className={classes.textDiv}>RAHAS AGENCIES</p>
          <p className={classes.textDiv2}>
            Dealer: Standard Fireworks <br />
      ...
      <Typography className={classes.textDiv1} variant="h6">
        Buy crackers of highest quality from supreme industries of crackers city
        and make your occasions safe and special !
      </Typography>
      <div
        style={{ position: "relative", zIndex: 200, marginTop: "20px" }}
      ...
      >
        ...
        <Typography
          variant="body1"
          style={{ align: "", color: "white", marginTop: "5px" }}
        >
          Old No. 18-D New No. 38, Sattur Road, Sivakasi - 626123,
          <li>
            +91 9944991567{" "}
            <a
              href="tel:+919944991567"
              style={{
                marginLeft: "4px",
                color: "#fb641b",
        ...
        >
          How to make orders? watch here{" "}
          <a
            href="https://www.youtube.com/watch?v=IgbveyYvLe0"
            style={{
              color: "#fb641b",
              backgroundColor: "transparent",
              textDecoration: "underline",
        ...
        <Typography
          ...
          style={{ align: "left", color: "white" }}
        >
          For queries regarding orders, submit your contact details, we will
          clarify.
        </Typography>
...
export default compose(
  graphql(productsForHome, {
    name: "productsForHome",
    options: async (props) => ({
      variables: {
        ip: props.ip,
        cartId: props.cartId,
  ...
  graphql(updateCartVerified, { name: "updateCartVerified" }),
)(Items);
