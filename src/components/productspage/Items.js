        ...
        <div >
          ...
          <Snackbar
            ...
            <Table style={{position:"fixed",backgroundColor:"white",zIndex:200}} >
                <TableRow >
                    ...
                    <FormControl variant="filled" className={classes.formControl}>
                        <InputLabel id="demo-simple-select-label" htmlFor="filled-age-native-simple">Buy other Category</InputLabel>
                            ...
                            >
                            { categories !== null &&
                                categories.map(category => <MenuItem value={category.id+","+category.categoryName} style={{width:"100%"}}>{category.categoryName}</MenuItem>)
                            }
                        </Select>
                        </FormControl>
                    </td>
                ...
                <TableRow>
                    <td style={{textAlign:'center'}} colSpan="2">
                        <Typography style={{color:"#4a4f4c"}} className={classes.categoryNameTypo}>
                            {props.categoryName}
                        </Typography>
                    </td>
                </TableRow>
            ...
            <div className={classes.topDiv1}>
                ...
                <Carousel>
                {
                    items.map( (i) =><img src={"/CategoryImagesServer/"+props.categoryId+"/"+i+".jpg"} className={classes.imageHide} alt="no preview" onError={(e)=>{e.target.onerror = null; e.target.src="/nopreview.png"}}/>)
                }
                </Carousel>
                </div>
                <div style={{width:"87%",marginLeft:"auto",marginRight:"auto"}} >
                    <table className={classes.imagesDiv} >
                        <tr>
                    {
                        items1.map( (i) =><td style={{textAlign:"center"}}><img src={"/CategoryImagesServer/"+props.categoryId+"/"+i+".jpg"} className={classes.imageHide} alt="Image not found" onError={(e)=>{e.target.onerror = null; e.target.src="/nopreview.png"}} /></td>)
                    }    
                        </tr>                
                    </table>
                </div>
                ...
                <Grid container>
                    {
                        products && products.map(item => {
                            ...
                            return productState[item.id] && <Grid xs={12} md={4} key={item.id} >
                                <Box
                                    boxShadow={20}
                                    ...
                                    <Grid container>
                                        <Grid item xs={12} >
                                           ...
                                           {item.productName}
                                            ...
                                            <Typography  className={classes.textSize1} align='left'  noWrap>
                                                {item.size} 
                                            </Typography>
                                        <Grid container>
                                        <Grid item xs={12}>
                                            <Typography   className={classes.textSize1}  align='center' style={{color:'green'}} noWrap>
                                                Type : {item.type}
                                            </Typography>
